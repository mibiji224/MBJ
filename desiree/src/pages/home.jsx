...
function Home() {
    ...
    useEffect(() => {
        ...
        }, 4000); // Change text every 4000ms (4s)
    ...
    return (
        <div className="relative min-h-screen bg-transparent text-white font-['Poppins'] overflow-hidden selection:bg-[#db0a0a] selection:text-black">
            ...
            <style>
                {`
                /* UPDATED ANIMATION: 
                   Runs once per text change (4s total).
                   Enters fast, stays visible, exits fast.
                */
                @keyframes textCycle {
            ...
            <section className="relative z-10 min-h-screen flex flex-col-reverse lg:flex-row items-center justify-center px-6 lg:px-20 gap-12 lg:gap-20" id="home">
                ...
                <div className="flex-1 flex flex-col items-center lg:items-start text-center lg:text-left">
                    ...
                    <span className="text-[#db0a0a] font-bold tracking-widest uppercase text-sm lg:text-base mb-4">
                    ...
                    <div className="flex items-center justify-center lg:justify-start gap-2 mt-4 text-2xl sm:text-3xl lg:text-4xl font-semibold">
                        <span className="text-gray-300">I am</span>

                        {/* Container needs fixed height to prevent layout shifts.
    ...
    hover:ring-2 hover:ring-white hover:ring-offset-2 hover:ring-offset-black"
                        ...
                        <div className="flex gap-4">
                            {/* LINKEDIN BUTTON */}
                            <a
                                href="https://www.linkedin.com/in/desireesoronio/"
                                target="_blank"
                                rel="noopener noreferrer"
                                aria-label="LinkedIn"
                                className="relative overflow-hidden group w-12 h-12 rounded-full border border-gray-700 flex items-center justify-center text-[#db0a0a] hover:bg-[#db0a0a] hover:text-black hover:border-[#db0a0a] transition-all duration-300 hover:shadow-[0_0_20px_#db0a0a]"
                            >
                                {/* DIAGONAL SHEEN EFFECT */}
                                <div className="absolute inset-0 -translate-x-full group-hover:translate-x-[150%] transition-transform duration-700 ease-in-out bg-gradient-to-r from-transparent via-white/40 to-transparent skew-x-12 z-0"></div>
                            ...
                            {/* GITHUB BUTTON (Now with Sheen Effect) */}
                            <a
                                href="https://github.com/mibiji224"
                                target="_blank"
                                rel="noopener noreferrer"
                                aria-label="GitHub"
                                className="relative overflow-hidden group w-12 h-12 rounded-full border border-gray-700 flex items-center justify-center text-[#db0a0a] hover:bg-[#db0a0a] hover:text-black hover:border-[#db0a0a] transition-all duration-300 hover:shadow-[0_0_20px_#db0a0a]"
                            >
                                {/* DIAGONAL SHEEN EFFECT ADDED HERE */}
                                <div className="absolute inset-0 -translate-x-full group-hover:translate-x-[150%] transition-transform duration-700 ease-in-out bg-gradient-to-r from-transparent via-white/40 to-transparent skew-x-12 z-0"></div>
                ...
                {/* --- RIGHT: IMAGE --- */}
                <div className="flex-1 flex justify-center lg:justify-end relative group lg:-translate-x-10">
                    <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[280px] h-[280px] sm:w-[350px] sm:h-[350px] bg-[#db0a0a] blur-[80px] rounded-full opacity-0 group-hover:opacity-50 transition-all duration-700 ease-in-out"></div>
                    <div className="relative z-10 animate-[float_6s_ease-in-out_infinite]">
                        <div className="relative w-[50vw] h-[50vw] sm:w-[300px] sm:h-[300px] lg:w-[350px] lg:h-[350px] rounded-full p-2 border-2 border-[#db0a0a]/30 bg-[#080707] transition-all duration-500 group-hover:border-[#db0a0a] group-hover:scale-105">
                            <img
